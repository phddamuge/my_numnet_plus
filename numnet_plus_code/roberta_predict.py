...
if args.tag_mspan:
    ...
    inf_iter = DropBatchGen(args, tokenizer,
        ...
        for i in range(len(output_dict["question_id"])):
            if "arithmetic_expression" in output_dict["answer"][i].keys():
                result[output_dict["question_id"][i]] = {
                    "predicted_answer": output_dict["answer"][i]["predicted_answer"],
                    "answer_type": output_dict["answer"][i]["answer_type"],
                    "arithmetic_expression": output_dict["answer"][i]["arithmetic_expression"]
                }
            else:
